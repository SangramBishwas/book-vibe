...
const ReadBook = ({ book }) => {
    const { image, name, author, category, totalPages, publisher, yearOfPublishing, rating, tags } = book;
    return (
        <div>
            <div className="card card-side bg-base-100 shadow-xl my-8 flex-col lg:flex-row">
                ...
                <div className="card-body">
                    ...
                    <p>By: {author}</p>
                    <div className='flex flex-col lg:flex-row gap-5 mb-4 items-center'>
